...
public class ArithmeticMutator extends Transformer {
	...
	public ArithmeticMutator(TransformInstance subject) {
		super(subject);
		transformerName = "ao";
	}
	...
	public void visit(BinaryExpr expr, Void arg) {
		...
		Expression rep = ObsoleteOperatorGenerator.fetchOperator(expr, type, "AOP");
		if (rep != null)
