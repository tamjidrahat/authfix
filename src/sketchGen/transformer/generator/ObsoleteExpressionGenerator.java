 ...
 */
package sketchGen.transformer.generator;
...
public class ObsoleteExpressionGenerator {
	...
	public static Expression fetchEXP(TransformInstance subject, String type) {
	...
	private static Expression fetchExpressionOnType(List<Node> nodes, String type, String query) {
		if (type == null || type.equals(""))
			return null;
		NameExpr clazz = new NameExpr(type); //Integer
		FieldAccessExpr field = new FieldAccessExpr(clazz, "class");//Integer.class
		...
		//System.out.println("---"+enclose.toString());
		return enclose;
	}
...
//		paramList.add(new IntegerLiteralExpr("0"));
	...
	public static void main(String[] args) {
		NodeList<Expression> paramList = new NodeList<Expression>();
		paramList.add(new IntegerLiteralExpr("0"));
		MethodCallExpr call = new MethodCallExpr(new NameExpr("objname"), new SimpleName("funcname"), paramList);
