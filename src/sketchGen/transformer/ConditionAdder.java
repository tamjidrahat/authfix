...
public class ConditionAdder extends Transformer {

	public ConditionAdder(TransformInstance subject) {
		super(subject);
		transformerName = "ca";
	}
	...
	// visited when the block with the faulty line/stmt is traversed
	public void visit(BlockStmt stmt, Void arg) {
		...
		NodeList<Expression> param = ObsoleteExpressionGenerator.getParameter(vars);
	...
	private void writeIfReturn(NodeList<Expression> param, String type, BlockStmt parent, int id) {
		...
		if (!returnType.equals("void"))
			rtnStmt = new ReturnStmt(ObsoleteExpressionGenerator.fetchEXP(subject, returnType));
